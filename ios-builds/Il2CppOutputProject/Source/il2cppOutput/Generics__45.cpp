...
IL_002f:
	...
	}
	{
		...
		bool L_11;
		L_11 = ValueTuple_2_Equals_mE26B775EA0BAAD220C697FCFE4AFD6D9A72FA04B(((L_8)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_9))), L_10, il2cpp_rgctx_method(method->klass->rgctx_data, 2));
		if (!L_11)
		{
			goto IL_0056;
		}
